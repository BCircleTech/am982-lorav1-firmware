...
void HAL_UART_MspInit(UART_HandleTypeDef* uartHandle)
{
  ...
  */
    ...
    PD1     ------> UART4_TX
    */
    GPIO_InitStruct.Pin = MCU_RX_Pin|MCU_TX_Pin;
  ...
  */
    ...
    PD2     ------> UART5_RX
    */
    GPIO_InitStruct.Pin = RS422_DI_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART5;
    HAL_GPIO_Init(RS422_DI_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = RS422_RO_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF8_UART5;
    HAL_GPIO_Init(RS422_RO_GPIO_Port, &GPIO_InitStruct);
  ...
  */
    ...
    PD15     ------> UART9_TX
    */
    GPIO_InitStruct.Pin = RTK_TX0_Pin|RTK_RX0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    ...
    /* UART9 DMA Init */
    /* UART9_TX Init */
    hdma_uart9_tx.Instance = DMA1_Stream0;
  ...
  */
    ...
    PD6     ------> USART2_RX
    */
    GPIO_InitStruct.Pin = RTK_RX2_Pin|RTK_TX2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    PG14     ------> USART6_TX
    */
    GPIO_InitStruct.Pin = RS232_RO0_Pin|RS232_TI0_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  */
    ...
    */
    ...
    /* USART10_RX Init */
    hdma_usart10_rx.Instance = DMA1_Stream7;
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* uartHandle)
{
  ...
  /* USER CODE END UART4_MspDeInit 0 */
    ...
    PD1     ------> UART4_TX
    */
    HAL_GPIO_DeInit(GPIOD, MCU_RX_Pin|MCU_TX_Pin);
  ...
  /* USER CODE END UART5_MspDeInit 0 */
    ...
    PD2     ------> UART5_RX
    */
    HAL_GPIO_DeInit(RS422_DI_GPIO_Port, RS422_DI_Pin);

    HAL_GPIO_DeInit(RS422_RO_GPIO_Port, RS422_RO_Pin);
  ...
  /* USER CODE END UART7_MspDeInit 0 */
    ...
    PB4(NJTRST)     ------> UART7_TX
    */
    HAL_GPIO_DeInit(GPIOB, RS485_RO_Pin|RS485_DI_Pin);
  ...
  /* USER CODE END UART9_MspDeInit 0 */
    ...
    PD15     ------> UART9_TX
    */
    HAL_GPIO_DeInit(GPIOD, RTK_TX0_Pin|RTK_RX0_Pin);
  ...
  /* USER CODE END USART2_MspDeInit 0 */
    ...
    PD6     ------> USART2_RX
    */
    HAL_GPIO_DeInit(GPIOD, RTK_RX2_Pin|RTK_TX2_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PG14     ------> USART6_TX
    */
    HAL_GPIO_DeInit(GPIOG, RS232_RO0_Pin|RS232_TI0_Pin);
  ...
  /* USER CODE END USART10_MspDeInit 0 */
    ...
    PG12     ------> USART10_TX
    */
    HAL_GPIO_DeInit(GPIOG, LORA_TX_Pin|LORA_RX_Pin);
